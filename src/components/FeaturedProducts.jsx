            ...
            <div key={category} className="mb-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {getProductsByCategory(category).map((product) => (
                  <div
                    key={product.id}
                    className="border border-gray-300 shadow-lg hover:cursor-pointer hover:scale-105 flex flex-col items-center"
                  >
                    {/* Product Image */}
                    <img
                      src={product.image}
                    ...
                    {/* Product Name */}
                    <h4 className="text-lg font-semibold text-center my-4">
                      {product.title}
                    </h4>
                  </div>
                ))}
